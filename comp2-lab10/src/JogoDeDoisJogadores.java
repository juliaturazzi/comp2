...
public abstract class JogoDeDoisJogadores {
    ...
    public double getPercentualVitoriasJogador1() {
       double contPontosJogador1 = 0;
       for(Partida resultado : historicoResultados) {
           if (resultado.contRodadasVencidasJogador1 > resultado.contRodadasVencidasJogador2) contPontosJogador1++;
       }
       return (contPontosJogador1/ historicoResultados.size()) * 100;
    }
    ...
    public double getPercentualVitoriasJogador2() {
        double contPontosJogador2 = 0;
        for(Partida resultado : historicoResultados) {
            if (resultado.contRodadasVencidasJogador2 > resultado.contRodadasVencidasJogador1) contPontosJogador2++;
        }
        return (contPontosJogador2/ historicoResultados.size()) * 100;
    }
    ...
    public double getPercentualEmpates() {
        double contEmpates = 0;
        for(Partida resultado : historicoResultados) {
            if (resultado.contRodadasVencidasJogador2 == resultado.contRodadasVencidasJogador1) contEmpates++;
        }
        return (contEmpates/ historicoResultados.size()) * 100;
    }
