...
//        }
    ...
    @Test(expected = UsuarioInexistenteException.class)
    public void testarUsuario() throws SenhaInvalidaException, UsuarioInexistenteException {
        Jogador jogadoraMaria = jogo.cadastrarJogador("maria", "3456");
        jogo.fazerLogin("joao", "3456");

        assertFalse(jogadoraMaria.isOnline());
    }

    @Test(expected = SenhaInvalidaException.class)
    public void testarSenha() throws SenhaInvalidaException, UsuarioInexistenteException {
        Jogador jogadoraMaria = jogo.cadastrarJogador("maria", "3456");
        jogo.fazerLogin("maria", "1234");
