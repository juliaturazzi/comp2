...
//        Collections.sort(listaDeJogadores);  aqui Jogador teria que implementar a interface Comparable<Jogador>
    ...
    public List<Jogador> obterJogadoresEmOrdemAlfabetica() {
        ...
        ArrayList<Jogador> ListaJogadoresAlfabetica = new ArrayList<>(this.jogadorByUsername.values());

        ComparadorDeJogadoresLexicografico comparator = new ComparadorDeJogadoresLexicografico();
        ListaJogadoresAlfabetica.sort(comparator);

        return ListaJogadoresAlfabetica;
    }
}